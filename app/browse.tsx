...
const styles = StyleSheet.create({
  ...
  backBtnWrap: { position: 'absolute', top: 54, left: 20, flexDirection: 'row', alignItems: 'center', gap: 8, zIndex: 30 },
  backBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(0,0,0,0.5)', alignItems: 'center', justifyContent: 'center' },
  albumTitle: { fontSize: 16, fontWeight: '600', color: '#fff', maxWidth: 200 },
  quickDeleteWrap: {
    position: 'absolute',
    top: 54,
    right: 20,
